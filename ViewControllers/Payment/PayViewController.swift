...
class PayViewController: ParentViewController, UIPickerViewDataSource, UIPickerViewDelegate, CardIOPaymentViewControllerDelegate, UITextFieldDelegate {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        txtCardNumber.borderWidth = 1
        txtCVV.borderWidth = 1
        txtExpiryDate.borderWidth = 1
            ...
            if (status) {
                ...
                DispatchQueue.main.async {
                    ...
                    if let res = result as? String {
                        UtilityClass.showAlertAnother("TickToc", message: res, vc: self)
                    }
                    else {
                        UtilityClass.showAlertAnother("TickToc", message: (result as! NSDictionary).object(forKey: "message") as! String, vc: self)
                    }
                }
            }
        }

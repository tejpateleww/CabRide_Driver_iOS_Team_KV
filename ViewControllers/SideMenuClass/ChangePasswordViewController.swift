...
class ChangePasswordViewController: ParentViewController {
    ...
    @IBAction func btnSubmit(_ sender: UIButton) {
        ...
        if inputText.count > 7 {
            ...
            let alert = UIAlertController(title: nil, message: "Password should be minimum 8 characters", preferredStyle: .alert)
        ...
        webserviceForChangePassword(dictdata as AnyObject) { (result, status) in
                ...
                if (status) {
                    ...
                    if let res = result as? String {
                        ...
                        let alert = UIAlertController(title: nil, message: (resDict).object(forKey: "message") as? String, preferredStyle: .alert)
